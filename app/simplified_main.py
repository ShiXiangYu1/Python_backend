...
class SimplifiedAPI(http.server.SimpleHTTPRequestHandler):
    ...
    def send_json_response(self, data):
        ...
        self.end_headers()
        self.wfile.write(json.dumps(data, cls=JSONEncoder, ensure_ascii=False, indent=2).encode('utf-8'))
    ...
    def handle_system_info(self):
        ...
        info = {
            ...
            "env_variables": {
                ...
                "MODEL_UPLOAD_DIR": os.environ.get("MODEL_UPLOAD_DIR", "./uploads/models")
            }
        }
