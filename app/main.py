...
def create_application() -> FastAPI:
    ...
    * **任务队列** - 异步任务处理
    ...
    app.add_middleware(
        CORSMiddleware,
        allow_origins=settings.CORS_ALLOW_ORIGINS if isinstance(settings.CORS_ALLOW_ORIGINS, list) else [origin.strip() for origin in settings.CORS_ALLOW_ORIGINS.split(",")],
