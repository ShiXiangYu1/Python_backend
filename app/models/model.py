...
from sqlalchemy import Boolean, Column, Enum as SQLAEnum, Float, ForeignKey, Integer, String, Text
...
class Model(BaseModel):
    ...
    # 模型版本（一对多）
    versions = relationship("ModelVersion", back_populates="parent_model", cascade="all, delete-orphan")
...
class ModelVersion(BaseModel):
    ...
    # 关系
    # 所属模型（多对一）
    parent_model_id = Column(String(36), ForeignKey("model.id", ondelete="CASCADE"), nullable=False)
